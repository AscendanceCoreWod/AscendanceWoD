/******************************************************************************
#________ _____________________   _____      _____  _____________________ 
#\______ \\______   \_   _____/  /  _  \    /     \ \_   _____/\______   \
# |    |  \|       _/|    __)_  /  /_\  \  /  \ /  \ |    __)_  |       _/
# |    `   \    |   \|        \/    |    \/    Y    \|        \ |    |   \
#/_______  /____|_  /_______  /\____|__  /\____|__  /_______  / |____|_  /
#        \/       \/        \/         \/         \/        \/         \/ 
#             _______________.___.________  .___   _____                  
#             \______   \__  |   |\______ \ |   | /  _  \                 
#              |       _//   |   | |    |  \|   |/  /_\  \                
#              |    |   \\____   | |    `   \   /    |    \               
#              |____|_  // ______|/_______  /___\____|__  /               
#                     \/ \/               \/            \/ 
*******************************************************************************/
...
public:
	...
	static bool HandlePhaseGoTargetCommand(ChatHandler * handler, const char * args)
	{
		...
		GameObject* target = handler->GetSession()->GetPlayer()->GetMap()->GetGameObject(ObjectGuid(HIGHGUID_GAMEOBJECT, id, lowguid));
	...
	static bool HandlePhaseGoDeleteCommand(ChatHandler * handler, const char * args)
	{
        ...
        if (ownerGuid)
		{
			...
			{
				handler->PSendSysMessage(LANG_COMMAND_DELOBJREFERCREATURE, ownerGuid.GetCounter(), obj->GetGUIDLow());
				handler->SetSentErrorMessage(true);
				return false;
			}
